...
function Drag.new(titleBar)
	-- titleBar  = cái thanh tiêu đề (Frame 30px)
	-- window    = parent chứa cả titleBar + container
	local window = titleBar.Parent  -- ScreenGui > Container > window frame
	...
	titleBar.InputBegan:connect(function(input)
		...
		-- offset tính từ góc trái-trên của cả window
